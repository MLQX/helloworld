package com.example.demo.hutool.log.dialect.tinylog;
...
public class TinyLog extends AbstractLog {
	...
	@Override
	public boolean isEnabled(com.example.demo.hutool.log.level.Level level) {
	 ...
	 * @since 4.0.3
	 */
	private Level toTinyLevel(com.example.demo.hutool.log.level.Level level) {
		Level tinyLevel;
		switch (level) {
		case TRACE:
